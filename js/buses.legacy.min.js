...
var LineDataManager = function () {
  ...
  LineDataManager.prototype.getLines = function getLines() {
    ...
    return this.getGroups().map(function (group) {
      var result = Object.assign({}, group, {
        rawLines: _this13.sortLines_(Array.from(_this13.linesByGroup_[group.id])),
        lines: []
      });
  ...
  LineDataManager.prototype.sortLines_ = function sortLines_(lines) {
    ...
    return lines.sort(function (a, b) {
      ...
      if (_this14.manifest.line_name_map) {
        if (_this14.manifest.line_name_map[a]) a = _this14.manifest.line_name_map[a];
        if (_this14.manifest.line_name_map[b]) b = _this14.manifest.line_name_map[b];
      }
      ...
      var result = _this14.compareWithoutCopyNumber_(a, b);
