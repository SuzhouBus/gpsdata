...
var LineDataManager = function () {
  ...
  LineDataManager.prototype.load = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(startDate, endDate) {
      var _this3 = this;

      var dataToLoad, startMonth, endMonth, archivedSources, _loop, currentMonth;
  ...
  LineDataManager.prototype.query = function query(lineOrLines, startDate, endDate) {
    ...
    var details = Object.keys(lineDetailsMap).sort().map(function (date) {
      return [date, buses.map(function (bus) {
        return lineDetailsMap[date][bus.licenseId];
      })];
    });
...
function initializeLineChooser() {
  ...
  if (!parseUrlHash()) showLine(lineChooser.children[0].value);
}
...
function parseUrlHash() {
  if (location.hash.replace('#', '')) {
    ...
    } else showLine(lineChooser.value = hashValue);
    return true;
  }
}
