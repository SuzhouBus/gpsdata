...
var LineDataManager = function () {
  ...
  LineDataManager.prototype.queryCurrentBus = function queryCurrentBus(line, licenseId) {
    var lineData = this.lineData_[line];
    if (!lineData) {
      ...
      lineData = this.lineData_[Object.keys(this.lineData_).find(function (cur) {
...
function loadBusUpdates() {
  ...
  return fetch('newbuses.csv', { cache: 'no-cache' }).then(function (r) {
    ...
    replaceChildren(updates_div, createElement('table', [createElement('thead', createElement('tr', ['时间', '线路', '自编号', '车牌号'].map(function (x) {
      ...
      return createElement('tr', [item.update_time.substring(5), item.line, (lineDataManager.queryCurrentBus(item.line, item.licenseId) || {}).busId || '', item.licenseId].map(function (x) {
