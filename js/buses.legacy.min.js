...
function showLinesNew(lineOrLines, lineData, showLineNames) {
  ...
  replaceChildren('content', createElement('table', [createTableHeader(data.buses, lineDataManager.hasBusId(lineOrLines)), createElement('tbody', data.details.map(function (day) {
    return createElement('tr', [createElement('th', day[0], { className: 'date' + (essentialSettings.annotateHolidays && holidayParser && holidayParser.isHoliday(day[0]) ? ' ' + DATE_HOLIDAY_CLASS : '') })].concat(_toConsumableArray(data.buses.map(function (bus, busIndex) {
