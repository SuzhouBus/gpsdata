...
var LineDataManager = function () {
  ...
  LineDataManager.prototype.initAsync = function initAsync() {
    ...
    return this.manifestLoader_.loadManifest().then(function (manifest) {
      _this3.manifest = manifest;
      if (_this3.manifestLoader_.offline) _this3.offline = _this3.manifestLoader_.offline;
      _this3.fetchSupportsReadableStream_ = _this3.manifestLoader_.fetchSupportsReadableStream;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return this.manifestLoader_.loadArchives().then(function (manifest) {
...
function init() {
  ...
  var settingsPromise = settings.initPromise.then(function (_) {
    return settings.get(['enabledGroups']).then(function (items) {
