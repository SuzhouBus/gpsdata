...
var LineDataManager = function () {
  ...
  LineDataManager.prototype.importData_ = function importData_(month, source) {
    ...
    Object.keys(data).forEach(function (line) {
      ...
      if (!_this8.linesByGroup_[groupId]) _this8.linesByGroup_[groupId] = new Set([lineName]);else _this8.linesByGroup_[groupId].add(lineName);
    });
  };
...
function navigateLine(increment, repeat) {
  ...
  if (lineChooser.children.length > 0 && newIndex > lineChooser.children.length - 1) newIndex = lineChooser.children.length - 1;
